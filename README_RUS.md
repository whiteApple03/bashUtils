...
- поддерживает все флаги (включая GNU версии), указанные выше.
...
- поддерживает следующие флаги: `-e`, `-i`, `-v`, `-c`, `-l`, `-n`, `-h`, `-s`, `-f`, `-o`.
- поддерживает все флаги, включая их _парные_ комбинации (например, `-iv`, `-in`).
